...
from roda.fetch_data import load_ceps, fetch_healthcare, fetch_rais, fetch_schools
...
def load_geolocated_layers(
    ...
    *,
    ...
    schools_raw = fetch_schools(
        municipalities, year_censo=year, billing_project_id=billing_project_id
    )
    ...
    rais_raw = fetch_rais(
        municipalities, years=year, billing_project_id=billing_project_id
    )
